...
class C_IO_base
{
	...
	void Set_base(E_IO_PORT_ADDR ,E_MODE_IO ,T_PORT );
...
inline void C_IO_base::Set_base_mode(E_MODE_IO _arg_io_base_mode)
{
	_mem_io_base_mode = _arg_io_base_mode;
}

void C_IO_base::Set_base(E_IO_PORT_ADDR _arg_io_base_addr, E_MODE_IO _arg_io_base_mode, T_PORT _arg_io_base_num)
{	
